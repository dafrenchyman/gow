...
["model3"]="/Applications/supermodel-emu.AppImage --appimage-extract-and-run -fullscreen -stretch -res=${GAMESCOPE_WIDTH},${GAMESCOPE_HEIGHT} \"${ROM}\"" \
...
["psvita"]="/Applications/vita3k-emu.AppImage --appimage-extract-and-run  \"${ROM}\"" \
